...
CREATE TYPE "public"."delivery_driver_status" AS ENUM (
    'offline',
    'available',
    'busy'
);
...
ALTER TYPE "public"."delivery_driver_status" OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."assign_super_admin_by_email"("user_email" "text") RETURNS TABLE("success" boolean, "message" "text", "profile_id" "uuid")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    target_profile_id UUID;
BEGIN
    SELECT id INTO target_profile_id FROM profiles WHERE email = user_email;
    
    IF target_profile_id IS NULL THEN
        RETURN QUERY SELECT false, 'User not found', NULL::UUID;
    ELSE
        UPDATE profiles SET role = 'super_admin' WHERE id = target_profile_id;
        RETURN QUERY SELECT true, 'User promoted to super_admin', target_profile_id;
    END IF;
END;
$$;


ALTER FUNCTION "public"."assign_super_admin_by_email"("user_email" "text") OWNER TO "postgres";
...
DECLARE
    new_order_code TEXT;
BEGIN
    -- Generates a random 8-character string, uppercase
    -- Ideally this should be a sequence or simpler logic
    new_order_code := upper(substring(md5(random()::text) from 1 for 8));
...
DECLARE
  ...
  v_full_name TEXT;
BEGIN
  -- Extract role from metadata, ensure it's lowercase and valid
  BEGIN
    v_role := LOWER(COALESCE(new.raw_user_meta_data->>'role', 'client'))::user_role;
...
CREATE OR REPLACE FUNCTION "public"."is_point_in_coverage"("p_lat" double precision, "p_lng" double precision) RETURNS TABLE("zone_id" "uuid", "zone_name" "text", "base_delivery_cost" double precision, "estimated_delivery_time_minutes" integer)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    -- This is a stub. Real implementation requires Point vs Polygon check.
    -- Example returning empty or first active zone
    RETURN QUERY 
    SELECT id, name, coverage_zones.base_delivery_cost, coverage_zones.estimated_delivery_time_minutes 
    FROM coverage_zones 
...
ALTER FUNCTION "public"."is_point_in_coverage"("p_lat" double precision, "p_lng" double precision) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_zone_geometry"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF NEW.polygon IS NOT NULL THEN
     NEW.geom = ST_GeomFromGeoJSON(
        jsonb_build_object(
            'type', 'Polygon',
            'coordinates', jsonb_build_array(
                (SELECT jsonb_agg(jsonb_build_array((p->>'lng')::numeric, (p->>'lat')::numeric)) 
                 FROM jsonb_array_elements(NEW.polygon) AS p)
            )
        )::text
     );
  END IF;
...
ALTER FUNCTION "public"."update_zone_geometry"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."coupons" (
    ...
    "is_for_new_users" boolean DEFAULT false,
    "store_id" "uuid",
    "category_id" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"()
);
...
ALTER TABLE "public"."coverage_history" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."coverage_zone_drivers" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "zone_id" "uuid",
    "driver_id" "uuid",
...
ALTER TABLE "public"."coverage_zone_drivers" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."coverage_zone_stats" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "zone_id" "uuid",
    "date" "date" NOT NULL,
    "total_orders" integer DEFAULT 0,
    "total_revenue" double precision DEFAULT 0,
    "average_delivery_time_minutes" double precision,
...
ALTER TABLE "public"."coverage_zone_stats" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."coverage_zone_stores" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "zone_id" "uuid",
    "store_id" "uuid",
    "is_enabled" boolean DEFAULT true,
...
ALTER TABLE "public"."coverage_zone_stores" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."coverage_zones" (
    ...
    "base_delivery_cost" double precision,
...
CREATE TABLE IF NOT EXISTS "public"."delivery_drivers" (
    ...
    "license_plate" "text",
    "documents_url" "text",
    "status" "public"."delivery_driver_status" DEFAULT 'offline'::"public"."delivery_driver_status",
...
ALTER TABLE "public"."flash_offers" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."orders" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "delivery_tier" integer,
    "delivery_type" character varying(50),
    "delivery_pin" character varying(10)
);
...
CREATE TABLE IF NOT EXISTS "public"."store_trusted_drivers" (
    "store_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."store_trusted_drivers" OWNER TO "postgres";


COMMENT ON TABLE "public"."store_trusted_drivers" IS 'Relationship between stores and their preferred delivery drivers.';
...
CREATE TABLE IF NOT EXISTS "public"."stores" (
    ...
    "logo_url" "text",
    "banner_url" "text",
    "status" "public"."store_status" DEFAULT 'pending_approval'::"public"."store_status",
    "rating" double precision DEFAULT 0,
...
ALTER TABLE ONLY "public"."coverage_zone_drivers"
    ADD CONSTRAINT "coverage_zone_drivers_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."coverage_zone_stats"
    ADD CONSTRAINT "coverage_zone_stats_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."coverage_zone_stores"
    ADD CONSTRAINT "coverage_zone_stores_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."flash_offers"
    ADD CONSTRAINT "flash_offers_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."store_trusted_drivers"
    ADD CONSTRAINT "store_trusted_drivers_pkey" PRIMARY KEY ("store_id", "driver_id");
...
CREATE OR REPLACE TRIGGER "tr_update_zone_geometry" BEFORE INSERT OR UPDATE ON "public"."coverage_zones" FOR EACH ROW EXECUTE FUNCTION "public"."update_zone_geometry"();



ALTER TABLE ONLY "public"."audit_log"
    ADD CONSTRAINT "audit_log_admin_id_fkey" FOREIGN KEY ("admin_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."chat_messages"
    ADD CONSTRAINT "chat_messages_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id");
...
ALTER TABLE ONLY "public"."client_addresses"
    ADD CONSTRAINT "client_addresses_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."coupons"
    ADD CONSTRAINT "coupons_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "public"."store_categories"("id");
...
ALTER TABLE ONLY "public"."coverage_history"
    ADD CONSTRAINT "coverage_history_changed_by_fkey" FOREIGN KEY ("changed_by") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."coverage_history"
    ADD CONSTRAINT "coverage_history_zone_id_fkey" FOREIGN KEY ("zone_id") REFERENCES "public"."coverage_zones"("id");



ALTER TABLE ONLY "public"."coverage_zone_drivers"
    ADD CONSTRAINT "coverage_zone_drivers_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."coverage_zone_drivers"
    ADD CONSTRAINT "coverage_zone_drivers_zone_id_fkey" FOREIGN KEY ("zone_id") REFERENCES "public"."coverage_zones"("id");



ALTER TABLE ONLY "public"."coverage_zone_stats"
    ADD CONSTRAINT "coverage_zone_stats_zone_id_fkey" FOREIGN KEY ("zone_id") REFERENCES "public"."coverage_zones"("id");



ALTER TABLE ONLY "public"."coverage_zone_stores"
    ADD CONSTRAINT "coverage_zone_stores_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id");



ALTER TABLE ONLY "public"."coverage_zone_stores"
    ADD CONSTRAINT "coverage_zone_stores_zone_id_fkey" FOREIGN KEY ("zone_id") REFERENCES "public"."coverage_zones"("id");



ALTER TABLE ONLY "public"."coverage_zones"
    ADD CONSTRAINT "coverage_zones_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."coverage_zones"
    ADD CONSTRAINT "coverage_zones_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."delivery_drivers"
    ADD CONSTRAINT "delivery_drivers_id_fkey" FOREIGN KEY ("id") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."flash_offers"
    ADD CONSTRAINT "flash_offers_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."orders"
    ADD CONSTRAINT "orders_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "public"."profiles"("id");
...
ALTER TABLE ONLY "public"."orders"
    ADD CONSTRAINT "orders_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "public"."delivery_drivers"("id");
...
ALTER TABLE ONLY "public"."platform_config"
    ADD CONSTRAINT "platform_config_updated_by_fkey" FOREIGN KEY ("updated_by") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."product_categories"
    ADD CONSTRAINT "product_categories_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id");
...
ALTER TABLE ONLY "public"."store_trusted_drivers"
    ADD CONSTRAINT "store_trusted_drivers_driver_id_fkey" FOREIGN KEY ("driver_id") REFERENCES "public"."delivery_drivers"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."store_trusted_drivers"
    ADD CONSTRAINT "store_trusted_drivers_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."stores"("id") ON DELETE CASCADE;
...
CREATE POLICY "Admins gestionan zonas" ON "public"."coverage_zones" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = ANY (ARRAY['super_admin'::"public"."user_role", 'ally_admin'::"public"."user_role"])))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = ANY (ARRAY['super_admin'::"public"."user_role", 'ally_admin'::"public"."user_role"]))))));



CREATE POLICY "Clients can insert their own order items" ON "public"."order_items" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."orders"
  WHERE (("orders"."id" = "order_items"."order_id") AND ("orders"."client_id" = "auth"."uid"())))));



CREATE POLICY "Clients can insert their own orders" ON "public"."orders" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "client_id"));



CREATE POLICY "Clients can view their own orders" ON "public"."orders" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "client_id"));



CREATE POLICY "Drivers can see their trusted status" ON "public"."store_trusted_drivers" FOR SELECT TO "authenticated" USING (("driver_id" = "auth"."uid"()));



CREATE POLICY "Drivers can view orders" ON "public"."orders" FOR SELECT TO "authenticated" USING ((("status" = 'created'::"public"."order_status") OR ("driver_id" = "auth"."uid"())));



CREATE POLICY "Public can view active flash offers" ON "public"."flash_offers" FOR SELECT USING ((("is_active" = true) AND ("expires_at" > "now"())));
...
CREATE POLICY "Public/Authenticated can see trusted drivers" ON "public"."store_trusted_drivers" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Store owners can manage their own offers" ON "public"."flash_offers" USING ((EXISTS ( SELECT 1
   FROM "public"."stores"
  WHERE (("stores"."id" = "flash_offers"."store_id") AND ("stores"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Store owners can manage their trusted drivers" ON "public"."store_trusted_drivers" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."stores"
  WHERE (("stores"."id" = "store_trusted_drivers"."store_id") AND ("stores"."owner_id" = "auth"."uid"()))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."stores"
  WHERE (("stores"."id" = "store_trusted_drivers"."store_id") AND ("stores"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Stores can view their own orders" ON "public"."orders" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."stores"
  WHERE (("stores"."id" = "orders"."store_id") AND ("stores"."owner_id" = "auth"."uid"())))));



CREATE POLICY "Super admin can update all profiles" ON "public"."profiles" FOR UPDATE USING ("public"."is_super_admin"());



CREATE POLICY "Super admin can view all profiles" ON "public"."profiles" FOR SELECT USING ((("auth"."uid"() = "id") OR "public"."is_super_admin"()));



CREATE POLICY "Super admins can manage all trusted drivers" ON "public"."store_trusted_drivers" TO "authenticated" USING ("public"."is_super_admin"()) WITH CHECK ("public"."is_super_admin"());



CREATE POLICY "Super admins can update all stores" ON "public"."stores" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
...
CREATE POLICY "Users can view order items" ON "public"."order_items" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."orders"
  WHERE (("orders"."id" = "order_items"."order_id") AND (("orders"."client_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
           FROM "public"."stores"
          WHERE (("stores"."id" = "orders"."store_id") AND ("stores"."owner_id" = "auth"."uid"())))))))));
...
CREATE POLICY "Zonas visibles para todos" ON "public"."coverage_zones" FOR SELECT USING (("is_active" = true));
...
ALTER TABLE "public"."coverage_zone_drivers" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."coverage_zone_stats" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."coverage_zone_stores" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."store_trusted_drivers" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."assign_super_admin_by_email"("user_email" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."assign_super_admin_by_email"("user_email" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."assign_super_admin_by_email"("user_email" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_point_in_coverage"("p_lat" double precision, "p_lng" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."is_point_in_coverage"("p_lat" double precision, "p_lng" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_point_in_coverage"("p_lat" double precision, "p_lng" double precision) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_zone_geometry"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_zone_geometry"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_zone_geometry"() TO "service_role";
...
GRANT ALL ON TABLE "public"."coverage_history" TO "anon";
GRANT ALL ON TABLE "public"."coverage_history" TO "authenticated";
GRANT ALL ON TABLE "public"."coverage_history" TO "service_role";



GRANT ALL ON TABLE "public"."coverage_zone_drivers" TO "anon";
GRANT ALL ON TABLE "public"."coverage_zone_drivers" TO "authenticated";
GRANT ALL ON TABLE "public"."coverage_zone_drivers" TO "service_role";



GRANT ALL ON TABLE "public"."coverage_zone_stats" TO "anon";
GRANT ALL ON TABLE "public"."coverage_zone_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."coverage_zone_stats" TO "service_role";



GRANT ALL ON TABLE "public"."coverage_zone_stores" TO "anon";
GRANT ALL ON TABLE "public"."coverage_zone_stores" TO "authenticated";
GRANT ALL ON TABLE "public"."coverage_zone_stores" TO "service_role";
...
GRANT ALL ON TABLE "public"."flash_offers" TO "anon";
GRANT ALL ON TABLE "public"."flash_offers" TO "authenticated";
GRANT ALL ON TABLE "public"."flash_offers" TO "service_role";
...
GRANT ALL ON TABLE "public"."promotional_banners" TO "anon";
GRANT ALL ON TABLE "public"."promotional_banners" TO "authenticated";
GRANT ALL ON TABLE "public"."promotional_banners" TO "service_role";
...
GRANT ALL ON TABLE "public"."store_trusted_drivers" TO "anon";
GRANT ALL ON TABLE "public"."store_trusted_drivers" TO "authenticated";
GRANT ALL ON TABLE "public"."store_trusted_drivers" TO "service_role";
